...
describe('./api/', () => {
    ...
    describe('./api/users/:username', () => {
        describe('GET', () => {
            ...
            xit('responds with status 404 when the user does not exist', () => {
                return request.get('/api/users/janedoe').expect(404)
                //! still returns 200 when !username in usersModels
            });

            it('responds with status 405 if an unwanted method is attempted', () => {
                return request.patch('/api/users/lurker').expect(405)
            })
        })
    });
    describe('./articles', () => {
